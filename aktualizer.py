...
# 1. Inicjalizacja: Wczytujemy stałą mapę słupków i GTFS Static raz na starcie
...
# 2. Główna pętla odświeżająca dane w czasie rzeczywistym
while True:
    start_time = time.time()
    all_live_departures = []

    # Pobieramy odjazdy tylko dla słupków obecnych w mapie
    ...
    # Budujemy obiekt Protobuf GTFS-RT
    ...
    # Nadpisujemy plik binarnej ramki GTFS-RT
